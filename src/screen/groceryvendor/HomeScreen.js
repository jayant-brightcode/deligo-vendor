    ...
    return <View style={style.container}>
        ...
        <View style={{height:'26%',backgroundColor:Colors.light_green}}>
          ...
          <View style={{alignSelf:'center',padding:10,marginTop:'3%',flexDirection:'row',alignItems:'center'}}>
            ...
            <View>
            <Text style={{marginStart:'3%',fontFamily:'urbanistextrabold',fontSize:18,color:Colors.black}}>Rohan Grocery Store</Text>
         ...
         <TouchableWithoutFeedback onPress={()=>{
                 navigation.navigate("WaitingForPickupScreen")
               }}>
...
<TouchableWithoutFeedback onPress={()=>{
                 navigation.navigate("OutForDeliveryScreen")
               }}>
           ...
           <TouchableWithoutFeedback onPress={()=>{
                 navigation.navigate("DeliveredOrderScreen")
               }}>
...
<View style={{flexDirection:'column',justifyContent:'center',alignItems:'center',backgroundColor:Colors.white,width:50,marginStart:10}}>
 ...
 <TouchableWithoutFeedback onPress={()=>{
   navigation.navigate("ShopSettingScreen")
 }}>
<View style={{flexDirection:'column',justifyContent:'center',alignItems:'center',backgroundColor:Colors.white,width:50,marginStart:10}}>
