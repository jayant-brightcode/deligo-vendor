...
const FoodProductInformationRegistrationScreen = () => {
    ...
    <View style={{ alignItems: 'center', flex: 1 }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ width: '90%', alignSelf: 'center', marginTop: '4%' }}>
        <View>
          ...
          <TextInput
            style={styles.input}
            placeholder="Eg. cakes , biryani , cold-drinks"
    ...
    <Image
        ...
        <Text style={styles.addButtonText}>Add More</Text>
          ...
          <TouchableOpacity style={{ width: '100%', marginTop: '3%', marginBottom: 30 }} onPress={() => {
            navigation.navigate("FoodVendorShopPhotoRegistrationScreen")
          }}>
...
export default FoodProductInformationRegistrationScreen