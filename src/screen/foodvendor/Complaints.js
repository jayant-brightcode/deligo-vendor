...
const renderProducts = ({item})=>{
  ...
  return(
    ...
    //    navigation.navigate("FProductDetailScreen")
          ...
          <View style={{width:'95%',height:165,marginEnd:10,marginBottom:15,backgroundColor:Colors.white,borderRadius:10,elevation:1,alignSelf:'center'}}>


            <View style={{width:'100%',flexDirection:'row'}}>
            <Image style={{ width: 100, height: 100 ,marginStart:8,marginTop:8,borderRadius:1,padding:6,borderColor:Colors.gray,borderWidth:1}} source={item.image}></Image>
            ...
            <View style={{marginTop:'3%',marginStart:'4%'}}>
             ...
             <Text numColumns={2} style={{color:Colors.brown,fontFamily:'urbanistbold',fontSize:10,marginStart:3}}>ORDER ID - DLG7897870</Text>
             ...
             <Text numColumns={2} style={{color:Colors.white,fontFamily:'urbanistmedium',marginTop:10,fontSize:10,marginStart:3,backgroundColor:Colors.dark_green,width:80,padding:8,borderRadius:8,textAlign:'center'}}>Call Now</Text>
    ...
    return <View style={style.container}>
        ...
        <View style={{height:'7%' ,backgroundColor:Colors.light_green}}>
          ...
          <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <Text numberOfLines={1} style={{marginStart:'2%',marginTop:'3%',fontFamily:'urbanistmedium',marginStart:'5%',fontSize:16,color:Colors.textcolor}}>Complaints</Text>
            </View>
