...
const FoodCancelledOrderScreen = () =>{
  ...
  return(
    <TouchableWithoutFeedback onPress={()=>{
      ...
      navigation.navigate("FoodOrderDetailScreen",{page:route})
          ...
          <View style={{width:'90%',height:260,marginEnd:10,marginStart:10,borderTopColor:Colors.gray,borderTopWidth:0.7,marginBottom:15,backgroundColor:Colors.white,borderRadius:10,elevation:1,alignSelf:'center'}}>
    ...
    return <View style={style.container}>
        ...
        <View style={{height:'7%' ,backgroundColor:Colors.light_green}}>
          ...
          <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <Text numberOfLines={1} style={{marginStart:'2%',marginTop:'3%',fontFamily:'urbanistmedium',marginStart:'5%',fontSize:16,color:Colors.textcolor}}>Cancelled Orders (200)</Text>
            </View>
      ...
      case 'header':
        return (
          <View style={{ width: '95%', alignSelf: 'center', marginTop: '4%',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center'}}>
            ...
            <Text style={{ fontSize: 17, fontFamily: 'urbanistbold', color: Colors.textcolor,letterSpacing:3 }}>CANCELLED ORDERS</Text>
            <View style={{width:'20%',height:1,borderTopColor:Colors.dark_gray,borderTopWidth:2,borderStyle:"dotted"}}></View>
...
export default FoodCancelledOrderScreen