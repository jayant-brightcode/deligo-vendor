...
<View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
  ...
  <Text numberOfLines={1} style={{marginStart:'2%',marginTop:'3%',fontFamily:'urbanistmedium',marginStart:'5%',fontSize:16,color:Colors.textcolor}}>Restaurent Setting</Text>
  </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ width: '90%', alignSelf: 'center', marginTop: '4%' }}>
        <View>
          <Text style={styles.label}>Restaurent Name</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter Restaurent Name Here"
...
export default FoodShopSettingScreen